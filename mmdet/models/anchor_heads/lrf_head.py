# -*- coding: utf-8 -*-
"""
Created on Thu Dec 19 22:21:59 2019
...
class LRFHead(AnchorHead):

    def __init__(self,
                 input_size=300, # 512: 512
                 num_classes=81,
                 in_channels=(512, 1024, 512, 256, 256, 256), # 512: (512, 1024, 512, 256, 256, 256, 256)
                 anchor_strides=(8, 16, 32, 64, 100, 300),  #512:(8, 16, 32, 64, 128, 256, 512)
                 anchor_ratios=([2, 3], [2, 3], [2, 3], [2, 3], [2], [2]), #512:([2, 3],[2, 3], [2, 3], [2, 3], [2, 3], [2], [2])
